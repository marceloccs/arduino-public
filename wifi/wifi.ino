...
char ssid[] = "nao tenho wifi longo alcance"; //VARIÁVEL QUE ARMAZENA O NOME DA REDE SEM FIO
char pass[] = "somagi50d22";//VARIÁVEL QUE ARMAZENA A SENHA DA REDE SEM FIO
...
void setup(){
  ...
  WiFi.config(IPAddress(192,168,1,161)); //COLOQUE UMA FAIXA DE IP DISPONÍVEL DO SEU ROTEADOR
  ...
  while(status != WL_CONNECTED){
    ...
    Serial1.println("serial value : "+status);
  }
  server.begin();
